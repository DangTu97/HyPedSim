...
* Author: hdang
* Description: Create a graph network (medial axis) and navigation meshes of the environment using voronoi diagram.
* Idea: Create voronoi diagram using points on the boundary of obstacles
* voronoi edges (medial axis) => graph network
* voronoi cells => navigation meshes
* Tags: medial axis, graph network, navigation mesh
*/
